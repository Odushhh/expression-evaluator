...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_conditional = 25,               /* conditional  */
...
{
       0,    45,    45,    55,    58,    61,    70,    81,    84,   105,
     108,   111,   129,   136,   139,   142,   148,   151,   154
};
#endif
...
static const char *const yytname[] =
{
  ...
  "statement", "assignment", "conditional", "expression", "term", "factor", YY_NULLPTR
};
...
{
      -3,   -14,    -7,     3,     0,    27,    16,   -14,   -14,    14,
      15,   -14,     0,     0,   -14,    -6,   -14,   -14,     0,     0,
       0,     0,     0,    14,     1,   -14,    15,    15,    15,   -14,
     -14,    -3,    28,    -3,   -14
};
...
{
       0,    16,    17,     0,     0,     0,     0,     4,     5,     3,
      12,    15,     0,     0,    17,     0,     1,     2,     0,     0,
       0,     0,     0,     6,     0,    18,     9,    10,    11,    13,
      14,     0,     7,     0,     8
};
...
{
       1,     2,     3,     1,    14,    18,    19,    26,    27,    28,
      20,    12,    18,    19,    25,    15,     4,    20,    32,     4,
      34,    31,    13,    23,    24,    18,    19,    16,    21,    22,
      20,    29,    30,    17,    33
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     3,     4,    11,    12,    18,    19,    20,
      16,    18,    11,    12,    20,     4,    19,    16,    31,    19,
      33,    20,    19,    12,    13,    11,    12,     0,    13,    14,
      16,    21,    22,    17,     6
};
...
{
       0,     3,     4,     5,    19,    22,    23,    24,    25,    26,
      27,    28,    18,    19,     4,    26,     0,    17,    11,    12,
      16,    13,    14,    26,    26,    20,    27,    27,    27,    28,
      28,    20,    23,     6,    23
};
...
#line 1141 "parser.tab.c"
  ...
  case 6: /* assignment: IDENTIFIER '=' expression  */
#line 70 "parser.y"
                              {
	insertSymbol((yyvsp[-2].id), "int", 0);
        (yyval.ast) = createBinaryNode("assign", createIdentifierNode((yyvsp[-2].id)), (yyvsp[0].ast));
    }
#line 1150 "parser.tab.c"
    break;

  case 7: /* conditional: IF '(' expression ')' statement  */
#line 81 "parser.y"
                                                     {
        (yyval.ast) = createIfElseNode((yyvsp[-2].ast), (yyvsp[0].ast), NULL);
    }
#line 1158 "parser.tab.c"
    break;

  case 8: /* conditional: IF '(' expression ')' statement ELSE statement  */
#line 84 "parser.y"
                                                     {
        (yyval.ast) = createIfElseNode((yyvsp[-4].ast), (yyvsp[-2].ast), (yyvsp[0].ast));
    }
...
#line 105 "parser.y"
                        {
        (yyval.ast) = createBinaryNode("add", (yyvsp[-2].ast), (yyvsp[0].ast));
    }
...
#line 108 "parser.y"
                          {
        (yyval.ast) = createBinaryNode("sub", (yyvsp[-2].ast), (yyvsp[0].ast));
    }
...
#line 111 "parser.y"
                          {
        (yyval.ast) = createBinaryNode("gt", (yyvsp[-2].ast), (yyvsp[0].ast));
    }
...
#line 136 "parser.y"
                    {
        (yyval.ast) = createBinaryNode("mul", (yyvsp[-2].ast), (yyvsp[0].ast));
    }
...
#line 139 "parser.y"
                      {
        (yyval.ast) = createBinaryNode("div", (yyvsp[-2].ast), (yyvsp[0].ast));
    }
...
#line 148 "parser.y"
           {
        (yyval.ast) = createTerminalNode("number", (yyvsp[0].num));
    }
...
#line 151 "parser.y"
                 {
        (yyval.ast) = createIdentifierNode((yyvsp[0].id));
    }
